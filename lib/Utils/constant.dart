...
class AppColor {
  static const lightPrimaryColor = Color(0xffAF6FBA);
  static const primaryColor = Color(0xff451d5f);
  static const whiteColor = Color(0xFFFFFFFF);
  static const blackColor = Color(0xFF000000);
  static const textPrimaryColor = Color(0xFF121515);
  static const textHeadigColor = Color(0xff5D5D5D);
  ...
  static const yellowColor = Color(0xffFFF500);
  static const lightBlueColor = Color(0xff544d94);
